...
const Loading = () => {
  return (
    <div className="fixed inset-0 z-9999 flex flex-col items-center justify-center min-h-screen bg-linear-to-r from-[#40132d] to-[#d1955d] text-primary animate-fadeIn">
